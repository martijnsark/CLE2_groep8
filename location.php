        ...
        <div class="half-container">
            <form action="">
                ...
                <select id="location" name="location" required>
                    ...
                    <option value="Rotterdam Alexandrium">Rotterdam Alexandrium</option>
                    <option value="Rotterdam Zuid">Rotterdam Zuid</option>
                    <option value="Zoetermeer">Zoetermeer</option>
                </select>

                <button type="submit">Kies locatie</button>
            </form>
